  ...
  return (
    <div className="flex-1 flex flex-col bg-gradient-to-b from-[#FFFDF5] via-[#FFFBF0] to-[#FFF8E7] min-h-dvh justify-between">
      ...
      <div className="px-4 pt-4 flex items-center justify-between">
        ...
        <span className="text-xs font-black uppercase tracking-widest text-slate-500">Partner Access</span>
      </div>
      ...
      <div className="flex-1 flex flex-col justify-center px-4 py-8">
        <div className="w-full max-w-[390px] mx-auto bg-white rounded-[28px] border border-amber-100/80 p-6 sm:p-7 shadow-xl shadow-amber-900/5 animate-fade-in-up">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-slate-500 text-[11px] sm:text-xs font-bold uppercase tracking-wider mt-1.5">Welcome back, partner!</p>
          </div>
      ...
      <div className="py-4 text-center">
        <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">© SearchMyDriver Partner Security</p>
      </div>
    </div>
  );
};
