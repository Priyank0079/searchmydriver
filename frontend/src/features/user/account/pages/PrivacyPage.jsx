...
const sections = [
  {
    ...
    text: 'We only use the information needed to run your account, bookings, payments, support requests, and safety features.',
  },
  {
    icon: Database,
    title: 'How we use it',
  ...
  },
  {
    ...
    text: 'We use access controls, encrypted transport, and account checks to keep your profile and booking data secure.',
  },
];
